...
# input tanggal lahir
tglLahir =int(input ("BTW..." + nama +"kamu lahir tanggal berapa?"))

# kasih jeda 3 detik
time.sleep(3)

# input bulan lahir
blnLahir =int(input ("BTW..." + nama +"kamu lahir bulan berapa?"))
...
if (usia > 50):
    ...
    print("Kesehatan mental mulai dijaga ya, semangat")
else:
